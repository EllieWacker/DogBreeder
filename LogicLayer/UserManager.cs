...
namespace LogicLayer
{
    public class UserManager : IUserManager
    {
        ...
        public int UpdateUserApplication(int userID, bool oldApprovedApplication, bool newApprovedApplication)
        {
            ...
            try
            {
                result = _userAccessor.UpdateUserApplication(userID, oldApprovedApplication, newApprovedApplication);
                if (result == 0)
                {
        ...
        public int InsertUser(string givenName, string familyName, string phoneNumber, string email, bool approvedApplication)
        {
            ...
            try
            {
                result =(_userAccessor.InsertUser(givenName, familyName, phoneNumber, email, approvedApplication));
                if (result == 0)
                {
