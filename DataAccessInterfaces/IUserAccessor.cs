...
namespace DataAccessInterfaces
{
    public interface IUserAccessor
    {
        ...
        int InsertUser(string givenName, string familyName, string phoneNumber, string email, bool approvedApplication);
        List<User> SelectAllUsers();
        int UpdateUserApplication(int userID, bool oldApprovedApplication, bool newApprovedApplication);
