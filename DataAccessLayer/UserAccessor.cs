...
namespace DataAccessLayer
{
    public class UserAccessor : IUserAccessor
    {
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    ...
                    user = new UserVM()
                    {
                        ...
                        Email = email,
                        ApprovedApplication = reader.GetBoolean(5),
        ...
        public int UpdateUserApplication(int userID, bool oldApprovedApplication, bool newApprovedApplication)
        {
            int result = 0;
            ...
            var conn = DBConnection.GetConnection();
            // command
            var cmd = new SqlCommand("sp_update_user_application", conn);
            //type
            cmd.CommandType = CommandType.StoredProcedure;
            //parameters
            cmd.Parameters.Add("@UserID", SqlDbType.Int).Value = userID;
            cmd.Parameters.Add("@OldApprovedApplication", SqlDbType.Bit).Value = oldApprovedApplication;
            cmd.Parameters.Add("@NewApprovedApplication", SqlDbType.Bit).Value = newApprovedApplication;
        ...
        public int InsertUser(string givenName, string familyName, string phoneNumber, string email, bool approvedApplication)
        {
            int result = 0;
            //connection
            var conn = DBConnection.GetConnection();
            ...
            cmd.Parameters.Add("@Email", SqlDbType.NVarChar, 250).Value = email;
            cmd.Parameters.Add("@ApprovedApplication", SqlDbType.Bit).Value = approvedApplication;
