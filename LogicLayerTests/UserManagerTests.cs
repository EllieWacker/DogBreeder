...
namespace LogicLayerTests
{
    ...
    public class UserManagerTests
    {
        ...
        public void TestUpdateApplicationReturns1ForTrue()
        {
            //arrange
            const int userID = 1;
            const bool oldApprovedApplication = false;
            const bool newApprovedApplication = true;
            const int expectedResult = 1;

            //act
            int actualResult = _userManager.UpdateUserApplication(userID, oldApprovedApplication, newApprovedApplication);
        ...
        //[TestMethod]
        //public void TestUpdateUserReturns1ForTrue()
        //{
        //    //arrange
        //    const string oldPhoneNumber = "319-310-3453";
        //    const string newPhoneNumber = "newpassword";
        //    const int expectedResult = 1;
        //    int actualResult = 0;

        //    //act
        //    actualResult = _userManager.UpdateUserApplication(oldPhoneNumber, newPhoneNumber); // Update phone number
        ...
        public void TestInsertUserReturnsNewUserID()
        {
            ...
            const bool approvedApplication = true;

            const int expectedUserID = 1000002; 
            int actualUserID = 0;

            //act
            actualUserID = _userManager.InsertUser(givenName, familyName, phoneNumber, email, approvedApplication);
